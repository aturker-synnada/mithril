...
from original_impl import Decoder
...
def small_cnn_forward():
    ...
    model += ml.models.Convolution2D(3, 256, 1, 1)(input=ml.IOKey("input", shape=(None, 256, None, None)))
...
def run_mithril():
    ...
    pm = ml.compile(model, ml.TorchBackend(), jit=False, shapes={"input": [8, 256, 256, 128]}, data_keys={"input"}, file_path="ekmek.py")
